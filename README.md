...
- Click here for [live](https://k0ppai.github.io/to-do-list-app/dist/index.html) demo.
...
```sh
  cd my-folder
  git clone https://github.com/K0ppai/to-do-list-app.git
```
...
If you like this project, create a pull request or hit me up on my [Twitter](https://twitter.com/_koppai_) for any other thing.
